...
cin>>product_price;
	...
	friend ostream& operator <<(ostream &out, const product &d);
};
ostream& operator <<(ostream &out, const product &d)
{
    out<<"@@@ Store Name : SUPER MARKET @@@"<<endl;
    out<<"@@@ Store Timing : 8 AM TO 9 PM @@@"<<endl;
    out<<"@@@ Location : Ramnagara-562112 , BANGALORE @@@" <<endl;
    out<<"@@@ Sunday store will be closed @@@"<<endl;
    out<<"@@@ Contact Number : 9978567834 @@@"<<endl;
    out<<"@@@ Email ID - abcxyz@gmail.com @@@"<<endl;
    return out;
}
